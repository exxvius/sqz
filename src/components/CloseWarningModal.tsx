  ...
  return (
    ...
    >
      <div className="card confirm-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="muted">
          A run is in progress. Quitting now stops it — progress is saved and
          the run is resumable, but in-flight encodes are cancelled. You can
          minimize to the tray to keep encoding instead.
        </p>
